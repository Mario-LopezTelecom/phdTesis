...
\chapter[A superprocess with Upper Confidence Bounds for Cooperative Spectrum Sharing][A superprocess with UCB for CSS]{A superprocess with Upper Confidence Bounds for Cooperative Spectrum Sharing}
...
In an effort to devise more efficient management of spectrum access, dynamic spectrum access (DSA) policies have been proposed \cite{ref:Zhao2007}. 
