...
Finally, in this last chapter devoted to OSA, we hope to go one step further in increasing the industry's interest in OSA by proposing an application scenario within an operator's own cellular networks. Such inter-operator OSA may be approved by the industry (as they report in \cite{CTIA2011}) since it does not involve forced spectrum sharing with other entities, but a more efficient use of their own resources.
