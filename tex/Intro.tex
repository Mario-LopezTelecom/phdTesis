...
\subsection{Thesis Motivation and Objectives}
...
% Añadir cita que corrobore esto. De momento... 
...
With respect to open challenges in spectrum trading:
\begin{itemize}
...
Published as: sJ.~Alcaraz, M.~L\'{o}pez-Mart\'{i}nez, J.~Vales-Alonso, and J.~Garcia-Haro, ``On the impact of licensed users management on the efficiency of
...
\item J.~Alcaraz, J.~Ayala-Romero, M.~L\'{o}pez-Mart\'{i}nezz, and J.~Vales-Alonso, ``Response surface methodology for efficient spectrum reuse in cellular
...
Published as: M.~L\'{o}pez-Mart\'{i}nez, J.~J. Alcaraz, J.~Vales-Alonso, and J.~Garcia-Haro,
...
Submitted to: M.~L\'{o}pez-Mart\'{i}nez, J.~J. Alcaraz, B.~L., and M.~Zorzi, ``A superprocess with
