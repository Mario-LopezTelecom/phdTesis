...
% BD
\bibitem{ref:Chockler05}
G.~Chockler, M.~Demirbas, S.~Gilbert, C.~Newport, and T.~Nolte, ``Consensus and
  collision detectors in wireless ad hoc networks,'' in \emph{Proc. of the 24th
  Annual {ACM} Symposium on Principles of Distributed Computing}, 2005, pp.
  197--206.

\bibitem{ref:Stotas2010}
S.~Stotas and A.~Nallanathan, ``Overcoming the sensing-throughput tradeoff in
  cognitive radio networks,'' in \emph{{IEEE ICC}}, May 2010, pp. 1--5.

\bibitem{ref:Biglieri13}
E.~Biglieri, A.~Goldsmith, L.~Greenstein, N.~Mandayam, and H.~V. Poor,
  \emph{Principles of Cognitive Radio}.\hskip 1em plus 0.5em minus 0.4em\relax
  Cambridge Univ. Press.
\bibitem{ref:Zhang2013_wha}
C.~Zhang and K.~Shin, ``What should secondary users do upon incumbents'
  return?'' \emph{{IEEE} J. Sel. Areas Commun.}, vol.~31, no.~3, pp. 417--428,
  March 2013.

\bibitem{ref:Gabran2013}
W.~Gabran, C.-H. Liu, P.~Pawelczak, and D.~Cabric, ``Primary user traffic
  estimation for dynamic spectrum access,'' \emph{{IEEE} J. Sel. Areas
  Commun.}, vol.~31, no.~3, pp. 544--558, Mar. 2013.
...
\bibitem{ref:Zhou2009} X. W. Zhou, J. Ma, G. Y. Li, Y. H. Kwon, and A. C. K. Soong, ``Probability-based optimization of inter-sensing duration and power control in cognitive radio,'' \emph{IEEE Trans. Wireless Commun.}, vol. 8, no.
...
\bibitem{ref:Lee2008} W. Y. Lee and I. F. Akyildiz, ``Optimal spectrum sensing framework for cognitive radio network,'' IEEE Trans. Wireless Commun., vol. 7, no. 10, pp. 3845-3857, Oct. 2008.
\bibitem{ref:Zhang2012_opt} J. Zhang, L. Qi, H. Zhu, ``Optimization of MAC Frame Structure for Opportunistic Spectrum Access,'' \emph{Wireless Communications, IEEE Transactions on }, vol.11, no.6, pp.2036-2045, June 2012.
...
\bibitem{ref:Gittins1974}
J.~Gittins and D.~M. Jones, ``A dynamic allocation index for new-product
  chemical research,'' Cambdrige University Engineering Department Report
  CUED/A, Cambdrige University, Tech. Rep. Mgt Stud/TR13, 1974.

\bibitem{ref:Sutton1998}
R.~S. Sutton and A.~G. Barto, \emph{Reinforcement Learning: An
  Introduction}.\hskip 1em plus 0.5em minus 0.4em\relax A Bradford Book, 1998.

\bibitem{ref:Powell2012}
W.~B. Powell and I.~O. Ryzhov, \emph{Optimal Learning}.\hskip 1em plus 0.5em
  minus 0.4em\relax Wiley, 2012.

\bibitem{ref:Bubeck2012}
S.~Bubeck, ``Regret analysis of stochastic and nonstochastic multi-armed bandit
  problems,'' \emph{Foundations and Trends in Machine Learning}, vol.~5, no.~1,
  pp. 1--122, 2012.
...
\bibitem{AdvisorsonScience}
P.~C. of~Advisors~on Science and T.~(PCAST), ``Report to the president:
  Realizing the full potential of government-held spectrum to spur economic
  growth,'' PCAST, Tech. Rep., 2012.

\bibitem{Andrews2014}
J.~G. Andrews, S.~Buzzi, W.~Choi, S.~Hanly, A.~Lozano, A.~C. Soong, and J.~C.
  Zhang, ``What will 5g be?'' 2014.

\bibitem{CTIA2011}
C.~T.~W. Association, ``In the matter of promoting more efficient use of
  spectrum through dynamic spectrum use technologies. comments of ctia - the
  wireless association,'' CTIA - The Wirelss Association, Tech. Rep., 2011, eT
  Docket No. 10-237.

\bibitem{Baker2015}

M.~A. Baker. (2015, January) Ctia statement after the conclusion of the fcc’s
  aws-3 spectrum auction. CTIA Blog. [Online]. Available: \url{CTIA Statement
  After the Conclusion of the FCC’s AWS-3 Spectrum Auction}

\bibitem{Br2012}

B.~X. Chen. (2012, May) Q.\&a.: Martin cooper, father of the cellphone, on
  spectrum sharing. The New York Times. [Online]. Available:
  \url{http://bits.blogs.nytimes.com/2012/05/31/qa-marty-cooper-spectrum-sharing/}

\bibitem{Chen2012}

------. (2012, May) Q.\&a.: Wireless industry likes spectrum sharing, but still
  wants more. The New York Times. [Online]. Available:
  \url{http://bits.blogs.nytimes.com/2012/05/30/qa-ctia-spectrum-sharing/?_r=0}

\bibitem{Chen2012b}

------. (2012, April) Carriers warn of crisis in mobile spectrum. The New York
...
FCC. (2015) Interactive specrum chart. [Online]. Available:
  \url{http://reboot.fcc.gov/spectrumdashboard/searchSpectrum.seam}

\bibitem{Kelly2012}
R.~B. Kelly and A.~Lafrance, \emph{The International Comparative Legal Guide
  to: Telecommunication Laws and Regulations}.\hskip 1em plus 0.5em minus
  0.4em\relax Global Legal Group, 2012, ch. Spectrum Trading in the EU and the
  US - Shifting Ends and Means.

\bibitem{Nuechterlein2013}
J.~E. Nuechterlein, \emph{Digital Crossroads}.\hskip 1em plus 0.5em minus
  0.4em\relax The MIT PRESS, 2013.

\bibitem{Roche2015}

R.~Roche. (2015, February) Mobile usage continues to increase + projections say
  skyrocketing demand = more spectrum required. [Online]. Available:
...
\bibitem{Chen2008} Ruiliang Chen; Jung-Min Park; Reed, J.H., \enquote{Defense against Primary User Emulation Attacks in Cognitive Radio Networks,} \textit{IEEE Journal on Selected Areas in Communications,} vol.26, no.1, pp.25,37, Jan. 2008

\bibitem{Fettweis2014} Fettweis, G.P., \enquote {The Tactile Internet: Applications and Challenges,} \textit{IEEE Vehicular Technology Magazine}, vol.9, no.1, pp.64,70, March 2014

\bibitem{Zhang2013_self}Z. Zhang, K. Long, and J. Wang, “Self-organization paradigms and optimization approaches for cognitive radio technologies: a survey,” Wirel. Commun. IEEE, no. April, pp. 36–42, 2013.

\bibitem{Matinmikko2013} M. Matinmikko et al., \enquote{Cognitive Radio Trial Environment: First Live Authorised Shared Access (ASA) based Spectrum Sharing Demonstration,} \textit{IEEE Veh. Technol. Mag.,} vol. 8, no. 3, pp. 30-37, Sept. 2013.
